                                ...
                                <table className="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">
                                                <div className="d-flex align-items-center mt-2">
                                                    <img src={Vegetable2} className="img-fluid rounded-circle" style={{width: "90px", height: "90px"}} alt="" />
                                                </div>
                                            </th>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div className="d-flex align-items-center mt-2">
                                                    <img src={Vegetable5} className="img-fluid rounded-circle" style={{width: "90px", height: "90px"}} alt="" />
                                                </div>
                                            </th>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div className="d-flex align-items-center mt-2">
                                                    <img src={Vegetable3} className="img-fluid rounded-circle" style={{width: "90px", height: "90px"}} alt="" />
                                                </div>
                                            </th>
