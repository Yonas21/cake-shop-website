                    ...
                    <table className="table">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <div className="d-flex align-items-center">
                                        <img src={Vegetable3} className="img-fluid me-5 rounded-circle" style={{width: "80px", height: "80px"}} alt="" />
                                    </div>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <div className="d-flex align-items-center">
                                        <img src={Vegetable5} className="img-fluid me-5 rounded-circle" style={{width: "80px", height: "80px"}}  alt="" />
                                    </div>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <div className="d-flex align-items-center">
                                        <img src={Vegetable2} className="img-fluid me-5 rounded-circle" style={{width: "80px", height: "80px"}} alt="Veg" />
                                    </div>
                                </th>
                                <td>
